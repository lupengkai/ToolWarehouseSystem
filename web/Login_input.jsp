...
<head>
    ...
    <script type="text/javascript">
        function login() {
            ...
            location.href = "/login/staff?username=" + username + "&password=" + password;
        }
    </script>
...
<div class="lc-block" id="l-login" data-ng-class="{'toggled':lctrl.login === 1}">
    ...
    <form name="login" action="" method="post">
        <div class="input-group m-b-20">
            ...
            <div class="fg-line">
                <input type="text" class="form-control" name="username" id="username" placeholder="Username" regex="^\w{3,16}$"/>
            </div>
        </div>
        ...
        <div class="input-group m-b-20">
            ...
            <div class="fg-line">
                <input type="password" class="form-control" name="password" id="password" placeholder="Password" regex="^\w+"/>
            </div>
        </div>
    ...
    <a href="javascript:void(0)" onclick="javascript:document.login.action='/Login_login';document.login.submit();"
    ...
    <ul class="login-navigation">
        ...
        <li data-block="#l-forget-password" class="bgm-orange" data-ng-click="lctrl.login = 0; lctrl.forgot = 1">Forgot
            Password?
        </li>
    </ul>
</div>
